<template>
  <div class="color-info-panel">
    <div class="panel-header">
      <button class="close-button" @click="close"><img src="../assets/x-close.png" alt="Close" /></button>
    </div>
    <div class="colors">
      <p>Цвет:</p>
      <input
    ...
    <div
      class="contrast"
      v-if="colorContrast"
      :style="{ color: colorContrast < 4.5 ? 'red' : 'green' }"
    >
...
.color-info-panel {
  ...
  width: 250px;
  height: 230px;
  background: linear-gradient(to top right, #121bd3, #ececec,);
  display: flex;
